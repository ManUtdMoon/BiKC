...
class TrainTrajectoryTransformerWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: TrajectoryTransformerPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: TrajectoryTransformerPolicy = None
...
def main(cfg):
    workspace = TrainTrajectoryTransformerWorkspace(cfg)
    workspace.run()
