...
from diffusion_policy.policy.keypose_cnnmlp_policy import KeyposeCNNMLPPolicy
...
class TrainKeyposeCNNMLPWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: KeyposeCNNMLPPolicy = hydra.utils.instantiate(cfg.policy)
...
def main(cfg):
    workspace = TrainKeyposeCNNMLPWorkspace(cfg)
    workspace.run()
